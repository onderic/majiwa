         ...
         <div class="w-full px-4">
            <div class="mx-auto mb-12 max-w-[510px] text-center lg:mb-20">
               ...
               <p class="text-body-color text-base">
                  We provide a range of services to connect you with the nearest health centers, access educational resources, and get emergency contact information.
               </p>
            </div>
         </div>
      </div>
         ...
         <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            <div class="mb-9 rounded-[20px] bg-white p-10 shadow-2 hover:shadow-lg md:px-7 xl:px-10">
               ...
               <p class="text-body-color">
                  Locate the nearest health centers based on your current location with ease.
               </p>
            </div>
         </div>
         <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            <div class="mb-9 rounded-[20px] bg-white p-10 shadow-2 hover:shadow-lg md:px-7 xl:px-10">
               ...
               <p class="text-body-color">
                  Access a variety of health education materials and guides to help you stay informed.
               </p>
            </div>
         </div>
         <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            <div class="mb-9 rounded-[20px] bg-white p-10 shadow-2 hover:shadow-lg md:px-7 xl:px-10">
               ...
               <p class="text-body-color">
                  Quickly find and connect with emergency contact numbers for immediate assistance.
               </p>
            </div>
         </div>
      </div>
